...
# Core modules (provided by sonicpi-core):
# - util, studio, counter, promise, version, config/settings, thread_id
# already loaded via sonicpi-core
...
# DSL modules (synths/synthinfo provided by sonicpi-core)
require_relative "lang/western_theory"
require_relative "lang/sound"

# Optional modules - may need to be stubbed or made optional
# require_relative "gitsave"  # IDE feature
# require_relative "tau_api"  # MIDI/Link support
